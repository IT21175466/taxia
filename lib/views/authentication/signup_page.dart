      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            CustomTextField(controller: phoneController, labelText: "Province"),
            CustomTextField(controller: phoneController, labelText: "District"),
            PhoneTextField(
                controller: phoneController, labelText: "Phone Number"),
            CustomTextField(controller: phoneController, labelText: "Password"),
            SizedBox(
              height: 25,
            ),
            CustomButton(
